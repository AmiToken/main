...
let addr;
const sttaddr = "0xd462011Be055D8490318f3d6C2078bC0d06F2607";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xd462011Be055D8490318f3d6C2078bC0d06F2607";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://amitoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xd462011Be055D8490318f3d6C2078bC0d06F2607',
                    'symbol': 'AMI',
                    'decimals': '18',
                    'image': 'https://amitoken.net/img/logo.png',
                },
            },
